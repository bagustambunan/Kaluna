    ...
    <div className="relative overflow-hidden">
      ...
      <div className="absolute right-0 top-0 h-full w-[120px] flex">
        <button
          ...
          className="flex-1 flex items-center justify-center bg-blue-100 dark:bg-blue-950 hover:bg-blue-200 text-blue-700 dark:text-blue-300"
          aria-label="Ubah"
        >
          <Pencil size={16} />
        </button>
      ...
      {/* Main row */}
      <div
        className="relative bg-white dark:bg-[#121f33] flex items-center gap-3 px-4 py-3.5 transition-transform"
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-baseline justify-between gap-2">
            <span className="text-sm font-bold text-[#365b84] dark:text-blue-100 truncate">{category?.name ?? 'Lainnya'}</span>
            <span className="font-data text-[15px] font-bold text-[#17345e] dark:text-blue-50 shrink-0">{formatRupiah(expense.amount)}</span>
          </div>
          <div className="flex items-center gap-1.5 text-[11px] text-[#8ba0bb] dark:text-slate-500 mt-0.5">
        ...
        <div className="hidden md:flex items-center gap-1 shrink-0">
          <button
            ...
            className="p-1.5 text-[#91a4bd] hover:text-blue-600 hover:bg-blue-50 dark:hover:bg-blue-950 rounded-lg"
            aria-label="Ubah"
          >
            <Pencil size={14} />
          </button>
